...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-gray-100">
      ...
      {/* Resume Section */}
      <section id="resume" className="py-20 px-6 bg-gray-900/50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl font-bold text-center mb-16 text-white flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 text-gray-200">
                    ...
                    <span>rbp5812@nyu.edu</span>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-200">
                    <Phone className="h-5 w-5 text-green-400" />
                    <span>+1 929-424-7773</span>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-200">
                    <Linkedin className="h-5 w-5 text-blue-400" />
                    <a href="https://linkedin.com/in/rishabhbhaskarpatil" className="hover:text-blue-400 transition-colors">LinkedIn Profile</a>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-200">
                    <Github className="h-5 w-5 text-purple-400" />
                    <a href="https://github.com/rishswish" className="hover:text-purple-400 transition-colors">GitHub Profile</a>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-200">
                ...
                <div className="space-y-3">
                  <h4 className="text-lg font-semibold text-white">Alternative Resume Access:</h4>
                  <p className="text-sm text-gray-300">If download is blocked, contact me directly for resume via:</p>
                  <div className="flex space-x-3">
                    <Button size="sm" onClick={() => window.open('mailto:rbp5812@nyu.edu?subject=Resume Request', '_blank')} className="bg-blue-600 hover:bg-blue-700">
                      Email Me
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => window.open('https://linkedin.com/in/rishabhbhaskarpatil', '_blank')} className="border-blue-400 text-blue-300">
                      LinkedIn
                    </Button>
                  </div>
                </div>
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-white mb-6">Resume Summary</h3>
                <div className="space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold text-blue-400 mb-2">Current Status</h4>
                    <p className="text-gray-200">MS in Data Science student at NYU (GPA: 3.78/4.0)</p>
                    <p className="text-gray-200">Seeking Summer/Fall 2025 internships</p>
                  </div>
                  
                  <div>
                    <h4 className="text-lg font-semibold text-green-400 mb-2">Education</h4>
                    <p className="text-gray-200">• NYU MS Data Science (2024-2026)</p>
                    <p className="text-gray-200">• B.Tech Data Science, Honors (2020-2024, GPA: 3.96/4.0)</p>
                  </div>
                  
                  <div>
                    <h4 className="text-lg font-semibold text-purple-400 mb-2">Experience</h4>
                    <p className="text-gray-200">• NLP Intern - Muck Rack (Current)</p>
                    <p className="text-gray-200">• Generative AI Intern - Solar Secure (2023)</p>
                    <p className="text-gray-200">• ML Intern - Acmegrade (2022)</p>
                  </div>
                  
                  <div>
                    <h4 className="text-lg font-semibold text-yellow-400 mb-2">Key Skills</h4>
                    <p className="text-gray-200">Python, PyTorch, TensorFlow, NLP, Computer Vision, AWS, Big Data</p>
                  </div>
                  
                  <div>
                    <h4 className="text-lg font-semibold text-red-400 mb-2">Achievements</h4>
                    <p className="text-gray-200">• 3rd Prize ICDMAI 2024 (AI Track)</p>
                    <p className="text-gray-200">• Published in Springer LNNS 998</p>
                    <p className="text-gray-200">• 4 AWS Academy Certifications</p>
                  </div>
                </div>
              </CardContent>
            </Card>
